...
namespace aurora {
    ...
    void AuroraSwapChain::createSwapChain() {
    ...
    void AuroraSwapChain::createImageViews() {
    ...
    void AuroraSwapChain::createColorResources() {
    ...
    void AuroraSwapChain::createFramebuffers() {
    ...
    void AuroraSwapChain::createSyncObjects() {
    ...
    VkSurfaceFormatKHR AuroraSwapChain::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR> &availableFormats) {
    ...
    VkExtent2D AuroraSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities) {
    ...
    VkFormat AuroraSwapChain::findDepthFormat() {
