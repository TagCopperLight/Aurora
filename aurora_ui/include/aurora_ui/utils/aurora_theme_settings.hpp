...
namespace aurora {
    ...
    public:
        ...
        static constexpr const char* PURPLE          = "#D2BEFB";
        static constexpr const char* BLUE            = "#73BFF9";
        static constexpr const char* ORANGE          = "#F5BA60";
        static constexpr const char* GRAY            = "#404352";
